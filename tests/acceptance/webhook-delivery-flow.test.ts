    ...
    try {
      ...
      const createResponse = await app.inject({
        ...
        payload: {
          ...
          // P03-4 SSRF guard: hostname must resolve publicly; example.test does not.
          url: "https://example.com/periscan-webhook"
        },
      ...
      expect(auditJson).not.toContain("https://example.com/periscan-webhook");
    } finally {
      await app.close();
    }
  }, 30_000);
