...
describe("coordination docs", () => {
  ...
  it("requires source-first PRD audit protocol and requirement ledger before completion claims", async () => {
    ...
    expect(using).toContain("PRD_AUDIT_PROTOCOL.md");
    expect(using).toContain("PRD_SOURCE_COVERAGE_LEDGER.md");
    expect(using).toContain("PRD_REQUIREMENT_LEDGER.md");
    expect(using).toContain("full-PRD implementation completion report");
    expect(using).toContain("pnpm prd:audit");
