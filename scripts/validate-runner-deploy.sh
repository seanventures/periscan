...
require_contains "$DEPLOY_README" "runner.port_connect_check"
require_contains "$DEPLOY_README" "runner.ptr_lookup_check"
...
require_contains "$RUNNER_README" "runner.port_connect_check"
require_contains "$RUNNER_README" "runner.ptr_lookup_check"
...
require_contains "$SELF_CONTAINED_RUNNER_PRD" "BAS_AEV_PROGRAM.md"
require_contains "$SELF_CONTAINED_RUNNER_PRD" "customer runner polls outbound HTTPS for signed"
require_contains "$SELF_CONTAINED_RUNNER_PRD" "No inbound management"
require_contains "$SELF_CONTAINED_RUNNER_PRD" "scenario/content digest"
require_contains "$SELF_CONTAINED_RUNNER_PRD" "Denied work never queues"
...
require_contains "$SHARED_DOMAIN" "ServiceViaProxy is reserved for a future"
