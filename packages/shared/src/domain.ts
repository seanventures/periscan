...
export const ValidatedFindingSchema = TenantScopedEntitySchema.extend({
  ...
  // Operator-visible locator for AppSec rows (file path, host, resource).
  // Optional so path-only and legacy findings still parse. Never carry raw
  // scanner Match/Secret values here — redacted location + rule/class only.
