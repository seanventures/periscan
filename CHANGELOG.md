...
**Community catalog expansion on `main` after v0.11.0. Not a new tagged snapshot. Not GA.** Product [`LICENSE`](LICENSE) is **Apache-2.0**. Community edition is the open-core **validation slice**, not a full-BAS product.
