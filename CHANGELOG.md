...
This tag is the next product snapshot after Community GA `v0.12.0`. It is **not** full BAS, **not** module-wide live Atomic / Caldera / SharpHound / Metasploit, **not** a Wiz or Tenable replacement, and **not** analyst 95 / Magic Quadrant / Forrester Wave progress. Cloud stays 3 until a live Connected-AWS Prowler walk. Pathless Gitleaks findings stay Open. Node floor is **24**.
