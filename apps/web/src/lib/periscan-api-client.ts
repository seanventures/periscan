...
export class PeriscanApiClient {
  ...
  async getExecutionIntegrityHonesty(): Promise<ExecutionIntegrityHonesty> {
    return this.requestJson(
  ...
  async getModelExtractionHonesty(): Promise<ModelExtractionHonesty> {
    return this.requestJson(
  ...
  async listSafetyEquivalentPacks(): Promise<SafetyEquivalentPacksResponse> {
    return this.requestJson(
