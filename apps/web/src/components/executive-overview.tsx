        ...
        <div className="flex flex-wrap items-end gap-2">
          ...
          {ctemHonesty.boardPackEnabled ? (
            ...
            <button
              ...
              disabled
              data-testid="build-board-pack"
              title={ctemHonesty.headline ?? undefined}
              className={buttonClassName({ size: "sm", variant: "primary" })}
            >
              Build board pack
            </button>
        ...
        <div className="rounded-control border border-line bg-bg px-3 py-2">
          ...
          <p className="text-[11px] text-subtle">
            {ctemHonesty.showPercent
              ...
              : "Not a board number until measurement completes."}
          </p>
        </div>
        <div className="rounded-control border border-line bg-bg px-3 py-2">
          <p className="text-[10.5px] font-semibold uppercase tracking-[0.08em] text-subtle">
          ...
          <div className="flex flex-col gap-3 p-4">
            <div className="flex items-center gap-4">
              {ctemHonesty.showPercent ? (
                ...
                <div
                  ...
                  data-testid="ctem-readiness-honesty"
                  role="status"
                >
            ...
            <div className="border-t border-line pt-2 text-[10.5px] text-subtle">
              ...
              {ctemHonesty.showPercent ? (
                ...
                <p className="mt-1">
                  Stage weights are withheld until this is a measured result.
                </p>
              )}
