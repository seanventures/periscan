...
| A repository you own | Absolute **clone path** on this machine. Hosted `github.com/org/repo` is refused. |
...
1. Clone (or already have) a repo on disk. Use the **absolute** path.
