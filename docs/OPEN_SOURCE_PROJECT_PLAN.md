...
| Atomic/Caldera/SharpHound/Metasploit adapters | Qualification and edition review | Pinned scenarios, policy, cleanup and measured evidence |
...
- Public `README.md` rewritten for OSS onboarding (describe actual shipped BAS/AEV coverage).
...
- Unqualified execution or destructive behavior
...
5. BAS adapters follow scenario qualification, license disposition, customer authorization, bounded execution, cleanup and evidence requirements.
...
2. What is available: qualified BAS/AEV scenarios and evidence-backed validation; disclose missing adapters and platform support.
...
| Safety regression escapes | Zero Fixed-without-verify or unqualified execution |
...
- Bypassing adapter qualification to attract contributors
